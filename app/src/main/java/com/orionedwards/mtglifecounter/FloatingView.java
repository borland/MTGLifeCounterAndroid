...
public class FloatingView extends RelativeLayout {
    ...
    public void showInView(@NonNull final RelativeLayout parent, RelativeLayout.LayoutParams layoutParams, long callbackDurationMillis, long pauseDurationMillis, long fadeDurationMillis) {
        if(getParent() != null) {
            return; // already parented, animation mustn't have finished or something
        }

        // TODO what about null layout params? Centering, etc, etc!
